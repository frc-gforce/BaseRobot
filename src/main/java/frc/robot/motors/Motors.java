...
public enum Motors {
    ...
    SHOOT(10, "Shoot Motor", MotorType.kBrushless, MotorBrand.TALON_FX, false),
    FEED(23, "Feed Motor", MotorType.kBrushed, MotorBrand.SPARK_MAX, true),
    ...
    OPEN_INTAKE_RIGHT(24, "Open Intake Motor Right", MotorType.kBrushless, MotorBrand.SPARK_MAX, false),
    OPEN_INTAKE_LEFT(25, "Open Intake Motor Left", MotorType.kBrushless, MotorBrand.SPARK_MAX, false),
